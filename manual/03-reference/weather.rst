...
.. figure:: ./fig_WeatherDetail.png
    :align: center

*Legend*:

1. Station data including bering and distance
2. Current meteorological report
3. Decoded view of Current meteorological report
4. Weather forecast for station
5. Decoded view of weather forecast

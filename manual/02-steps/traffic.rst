...
traffic receiver (typically a FLARM device) or to the `SafeSky
<https://www.safesky.app>`_ app. Once connected, the moving map will show nearby
traffic.
...
In addition to hardware devices, the author has also tested **Enroute Flight
Navigation** with the following app.

- `SafeSky - The anti-collision app <https://www.safesky.app>`_
